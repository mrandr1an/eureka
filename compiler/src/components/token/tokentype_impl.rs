...
impl fmt::Display for Operator
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result
    {
        match self
        {
            ...
            Operator::Meta => write!(f, "+"),
            Operator::Define => write!(f, "+"),
            Operator::Data => write!(f, "+"),
            Operator::When => write!(f, "+"),
            Operator::Otherwise => write!(f, "+"),
            Operator::Halt => write!(f, "+"),
